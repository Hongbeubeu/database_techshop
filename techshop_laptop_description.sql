...
DROP TABLE IF EXISTS `laptop_description`;
...
CREATE TABLE `laptop_description` (
  ...
  CONSTRAINT `fk_latop_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
LOCK TABLES `laptop_description` WRITE;
/*!40000 ALTER TABLE `laptop_description` DISABLE KEYS */;
/*!40000 ALTER TABLE `laptop_description` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-17 16:10:14
